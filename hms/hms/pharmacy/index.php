...
{
	//PLEASE CHANGE THIS ACCORDING TO THE DATABASE
$ret=mysqli_query($con,"SELECT * FROM pharmacists WHERE pharmEmail='".$_POST['username']."' and pharmPassword='".md5($_POST['password'])."'");
