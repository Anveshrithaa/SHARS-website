...
?>
											...
											<br>
											<a href='confirm.php?pat=<?php echo $tmp;?>&pharm=<?php echo $pname1;?>'><button type="button" class="btn btn-success btn-xs">Confirm</button></a>
											<a href='cancel.php?pat=<?php echo $tmp;?>&pharm=<?php echo $pname1;?>'><button type="button" class="btn btn-danger btn-xs">Cancel</button></a>
											</p>
										</div>
									</div>
								</div>
