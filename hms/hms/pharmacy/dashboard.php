						...
						<!-- start: BASIC EXAMPLE -->
							...
							<div class="row">
                                ...
                                <div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											<span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i class="fa fa-cart-plus fa-stack-1x fa-inverse"></i> </span>
											<h2 class="StepTitle">View Orders</h2>
								...
								<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											<span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i class="fa fa-cart-plus fa-stack-1x fa-inverse"></i> </span>
											<h2 class="StepTitle">View History</h2>
										
											<p class="cl-effect-1">
												<a href="past-order.php">
													View Past Orders
												</a>
											</p>
										</div>
