...
<div class="row">
<div class="col-sm-8">
<h1 class="mainTitle">User | View Scan/Test Details</h1>
</div>
<ol class="breadcrumb">
<li>
<span>User</span>
...
<li class="active">
<span>View Scan/Test Details</span>
</li>
</ol>
</div>
</section>
...
<div class="row">
<div class="col-md-12">
<h5 class="over-title margin-bottom-15">View <span class="text-bold">Scan/Test Details</span></h5>
<?php
                               $vid=$_GET['viewid'];
							   $scanid=$_GET['scanid'];
							   
$sql=mysqli_query($con,"select ID from tblpatient where PatientEmail=(select email from users where id='$vid')");

	$r=mysqli_fetch_array($sql);
	$uid=$r['ID'];
							   
							   
                               $ret=mysqli_query($con,"select * from tblpatient where ID='$uid'");
